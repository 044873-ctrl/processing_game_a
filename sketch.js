...
let playerHits=0;
let maxHits=3;
function spawnEnemy(){let enemyRadius=12;let ex=random(enemyRadius,canvasW-enemyRadius);let ey=-enemyRadius;let evy=2;let fireCooldown=floor(random(60,180));enemies.push({x:ex,y:ey,r:enemyRadius,vy:evy,fireCooldown:fireCooldown});}
